  ...
  if (this->cheatsEnabled)
  {
    ros::SubscribeOptions hand_wheel_cmd_so =
        ros::SubscribeOptions::create<std_msgs::Float64>(
            ...
            boost::bind(static_cast<void (DRCVehicleROSPlugin::*)(const std_msgs::Float64::ConstPtr &)>(
                            &DRCVehicleROSPlugin::SetHandWheelState),
                        this, _1),
    ...
    ros::SubscribeOptions hand_brake_cmd_so =
        ros::SubscribeOptions::create<std_msgs::Float64>(
            ...
            boost::bind(static_cast<void (DRCVehicleROSPlugin::*)(const std_msgs::Float64::ConstPtr &)>(
                            &DRCVehicleROSPlugin::SetHandBrakePercent),
                        this, _1),
            ros::VoidPtr(), &this->queue);
    ...
    ros::SubscribeOptions gas_pedal_cmd_so =
        ros::SubscribeOptions::create<std_msgs::Float64>(
            ...
            boost::bind(static_cast<void (DRCVehicleROSPlugin::*)(const std_msgs::Float64::ConstPtr &)>(
                            &DRCVehicleROSPlugin::SetGasPedalPercent),
                        this, _1),
            ros::VoidPtr(), &this->queue);
    ...
    ros::SubscribeOptions brake_pedal_cmd_so =
        ros::SubscribeOptions::create<std_msgs::Float64>(
            ...
            boost::bind(static_cast<void (DRCVehicleROSPlugin::*)(const std_msgs::Float64::ConstPtr &)>(
                            &DRCVehicleROSPlugin::SetBrakePedalPercent),
                        this, _1),
            ros::VoidPtr(), &this->queue);
    ...
    ros::SubscribeOptions key_cmd_so =
        ros::SubscribeOptions::create<std_msgs::Int8>(
            ...
            boost::bind(static_cast<void (DRCVehicleROSPlugin::*)(const std_msgs::Int8::ConstPtr &)>(
                            &DRCVehicleROSPlugin::SetKeyState),
                        this, _1),
            ros::VoidPtr(), &this->queue);
    ...
    ros::SubscribeOptions direction_cmd_so =
        ros::SubscribeOptions::create<std_msgs::Int8>(
            ...
            boost::bind(static_cast<void (DRCVehicleROSPlugin::*)(const std_msgs::Int8::ConstPtr &)>(
                            &DRCVehicleROSPlugin::SetDirectionState),
                        this, _1),
            ros::VoidPtr(), &this->queue);
